...
// Query: *[_type == "product" && "featured" in tags] | order(_createdAt desc, _id desc)[$start...$end]{    _id,  "slug": slug.current,  name,  description,  discountPrice,  price,  rating,  productImage { asset->{ url } },  tags,}
